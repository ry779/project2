  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">aplikasi rayhan</span>
      </a>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
            ...
            <li class="message-item">
              <a href="#">
                <img src="{{asset("NiceAdmin/asset/img/messages-1.jpg") }}assets/img/messages-1.jpg" alt="" class="rounded-circle">
                <div>
                  <h4></h4>
                  <p></p>
                  <p></p>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="accountsetting.blade.php">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="help_me.blade.php">
...
{{--  --}}
          ...
          {{-- <li>
            <a href="/jenisjenisproduk">
              <i class="bi bi-circle"></i><span>jenis jenis produk</span>
            </a>
          </li> --}}
          {{-- <li>
      ...
      {{-- <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="tutorial">
              <i class="bi bi-circle"></i><span>tutorial pt</span>
            </a> --}}
          {{-- </li>
          <li>
            <a href="aset">
...
{{--
  ...
  <script src="{{asset("NicdAdmin/assets/vendor/tinymce/tinymce.min.js")}}"></script>
